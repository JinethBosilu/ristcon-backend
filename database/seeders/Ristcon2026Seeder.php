    ...
    public function run(): void
    {
        ...
        DB::table('important_dates')->insert([
            ...
            [
                ...
                'is_extended' => false,
                'display_order' => 5,
                'display_label' => 'Registration Deadline',
                'notes' => 'All attendees, including presenters, must complete their registration by submitting the Registration Form. Both the form and payment receipt must be uploaded to the CMT system.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
        ...
        // 21. Create Abstract Formats
        DB::table('abstract_formats')->insert([
            [
                'conference_id' => $conferenceId,
                ...
                'max_keywords' => 5,
                'keywords_font_name' => 'Times New Roman',
                'keywords_font_size' => 11,
                'keywords_style' => 'italic',
                'max_references' => null,
                'sections' => null,
                'additional_notes' => 'Abstracts exceeding the word limit will be returned.',
                'display_order' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'conference_id' => $conferenceId,
                'format_type' => 'extended_abstract',
                'max_title_characters' => null,
                ...
                'body_line_spacing' => 1.5,
                'max_keywords' => null,
                'keywords_font_name' => null,
                'keywords_font_size' => null,
                'keywords_style' => null,
                'max_references' => 8,
                'sections' => json_encode(['Title', 'Abstract', 'Introduction', 'Materials & Methods', 'Results & Discussion', 'Conclusions', 'References']),
                'additional_notes' => 'All sections: Times New Roman 12, line spacing 1.5',
                'display_order' => 2,
                'created_at' => now(),
                'updated_at' => now(),
            ],
