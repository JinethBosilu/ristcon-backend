    ...
    public function run(): void
    {
        ...
        DB::table('conference_documents')->insert([
            ...
            [
                ...
                'file_name' => 'Author_Form_RISTCON2026.pdf',
                'file_path' => 'documents/2026/Author_Form_RISTCON2026.pdf',
                'display_name' => 'Download Author Form',
                'is_available' => true,
                'button_width_percent' => 70,
                'display_order' => 2,
        ...
        DB::table('author_page_config')->insert([
            ...
            'special_instructions' => 'All submissions must be original work not previously published. Blind review is strictly enforced - please remove author information from your submitted abstract.',
            'acknowledgment_text' => 'RISTCON 2026 will be using the Microsoft CMT (Conference Management Toolkit) system for submission and review management.',
            'created_at' => now(),
            'updated_at' => now(),
        ]);
        ...
        DB::table('submission_methods')->insert([
            [
                ...
                'notes' => 'Download and complete the author form, then email to the provided address',
                'display_order' => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ...
        DB::table('presentation_guidelines')->insert([
            ...
            [
                ...
                'physical_presence_required' => true,
                'detailed_requirements' => 'Posters must be printed in portrait orientation with dimensions 27" × 40". High-quality printing on matte paper is recommended. Poster boards and mounting materials will be provided.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ]);
